...
public class HttpClientUtils {
    ...
    public static HttpClientResult doGet(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        ...
        //log.info("get url:{} , header: {}, params: {}", url, headers, params);
        if (params != null) {
    ...
    public static HttpClientResult doPost(String url, Map<String, String> headers, Map<String, String> params) {
        ...
        //log.info("post url:{} , header: {}, params: {}", url, headers, params);
        /**
         * setConnectTimeout：设置连接超时时间，单位毫秒。
         * setConnectionRequestTimeout：设置从connect Manager(连接池)获取Connection
         * 超时时间，单位毫秒。这个属性是新加的属性，因为目前版本是可以共享连接池的。
		...
		*/
        httpPost.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36");
    ...
    public static HttpClientResult getHttpClientResult(CloseableHttpResponse httpResponse,
        ...
        for (int i = 0; i < (RE_TRY < 1 ? 1 : RE_TRY); i++) {
            try {
                // 执行请求
        ...
        if (httpResponse != null && httpResponse.getStatusLine() != null) {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_MOVED_TEMPORARILY) {
                ...
                httpResponse = null;
                return getHttpClientResult(httpResponse, httpClient, httpMethod);
            }
